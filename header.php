...
<html lang="en">
  <head>
    <title>SumoBank - Get Banking!</title>
    <meta charset="utf-8">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light top-nav" id="ftco-navbar">
	    <div class="container">
      <a href="index.php"><img src="images/sumobank_logo1.png" alt="sumobank_home"></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="about.php" class="nav-link">Testimonials</a></li>
